            ...
            <footer style={{ backgroundColor: "#223A5E" }}>
                <div className="row row-cols-1 row-cols-md-3 mx-2 mt-2 g-4 px-4 text-white border-bottom border-secondary">
                    ...
                    <div className="p-4">
                        ...
                        <p><i className="fas fa-envelope"></i> info123@bikevalley.com</p>
                ...
                <div className="text-light text-center p-4">
                    <p>Copyright <span>&copy;</span>2021 <span className="text-warning">Bike Valley</span> All rights reserved.</p>
                </div>
            </footer>
        </div>
    );
